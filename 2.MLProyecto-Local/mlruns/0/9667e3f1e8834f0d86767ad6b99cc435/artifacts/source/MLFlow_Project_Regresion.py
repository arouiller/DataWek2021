...
#@click.option('--data_file', default='c:\\database\\winedata\\winequality-red.csv', type=str, help='Data file')


def run(alpha, l1_ratio, experiment_name, run_name):#, l1_ratio, data_file, experiment_name, run_name):
    #alpha = 0.1
    #l1_ratio = 0.1
    #experiment_name = 'Default'
    #run_name = 'Ejecucion 1'
    data_file = 'c:\\database\\winedata\\winequality-red.csv'
    ...
    with mlflow.start_run(experiment_id=exp_id, run_name='Esta es una prueba', nested=True):
